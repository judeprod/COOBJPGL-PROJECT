...
public class LogInController {
    ...
    @FXML
    public void nextbtnbuttonHandler(ActionEvent event) throws IOException{
        
        // Retrieve username in text field
        String phoneno = spphoneno.getText();

        // Retrieve password in password field
        String pword = passwordfield.getText();

        // Create user object
        user = new User(phoneno, pword, "", "");
        ...
        if (accountsfile.exists()) {
            ...
            try {
                ...
                while (filescanner.hasNextLine()) {
                    ...
                    if (username_from_file.equals(user.getPhoneNo()) && password_from_file.equals(user.getPassword())) {
